...
class BaseJob(object):
    ...
    def convert_to_dictionary(self):
        dictionary = {
                ...
                'data': pickleFunctions.createPickle(self.data).decode('latin1'),
    ...
    def job_from_dictionary(self, data):
        ...
        self.data = pickleFunctions.unPickle(data['data'].encode('latin1')) if 'data' in data else ''
        self.job_id = pickleFunctions.unPickle(data['job_id'].encode('latin1')) if 'job_id' in data else ''
        self.function_name = data['function_name'] if 'function_name' in data else ''
        self.arguements = pickleFunctions.unPickle(data['arguements'].encode('latin1')) if 'arguements' in data else ()
        self.return_value = pickleFunctions.unPickle(data['return_value'].encode('latin1')) if 'return_value' in data else ''
